...
namespace PcWarehoseApi.Migrations
{
    ...
    [Migration("20260514115513_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PcWarehouseApi.Models.Component", b =>
                {
            ...
            modelBuilder.Entity("PcWarehouseApi.Models.ComponentManufacturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PcWarehouseApi.Models.ComponentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PcWarehouseApi.Models.PC", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PcWarehouseApi.Models.PCComponent", b =>
                {
                    b.Property<int>("PCId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PcWarehouseApi.Models.Component", b =>
                {
                    b.HasOne("PcWarehouseApi.Models.ComponentManufacturer", "ComponentManufacturer")
                        .WithMany("Components")
                        .HasForeignKey("ComponentManufacturerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PcWarehouseApi.Models.ComponentType", "ComponentType")
                        .WithMany("Components")
            ...
            modelBuilder.Entity("PcWarehouseApi.Models.PCComponent", b =>
                {
                    b.HasOne("PcWarehouseApi.Models.Component", "Component")
                        .WithMany("PCComponents")
                        .HasForeignKey("ComponentCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PcWarehouseApi.Models.PC", "PC")
                        .WithMany("PCComponents")
                        .HasForeignKey("PCId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
